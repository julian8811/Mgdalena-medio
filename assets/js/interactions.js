(function () {
  ...
  function mountFabDock() {
    ...
    dock.innerHTML = ''
      + '<button type="button" class="fab fab-compare" data-open-mm-compare data-tooltip="Comparar rutas 1, 2 y 5 (Magdalena Medio) vs cotización Yopal (PDF)" aria-haspopup="dialog" aria-controls="mm-compare-dialog" aria-expanded="false" aria-label="Abrir comparativo: rutas de cocreación 1 y 2, Ruta 5 completa y cotización Exclusive Nature Tours (1 persona)">'
  ...
  function mountCompareModal() {
    ...
    backdrop.innerHTML = ''
      ...
      +     '<p class="mm-compare-note">Son productos y destinos distintos. Los totales de rutas 1, 2 y 5 son referencias del sitio (1 persona); Exclusive Nature Tours corresponde a la cotización PDF prorrateada.</p>'
      +     '<div class="mm-compare-scroll">'
      +       '<h3 class="mm-compare-section-title">Rutas de cocreación (2 noches / 3 días) · total por persona</h3>'
      +       '<table class="mm-compare-table mm-compare-table--routes">'
      +         '<thead><tr><th>Ruta</th><th>Paquete en cotización</th><th>Total referencial (1 pax, COP)</th></tr></thead>'
      +         '<tbody>'
      +           '<tr><td class="mm-compare-route-name"><strong>Ruta 1</strong> · Vive la ganadería, no la mires desde lejos</td><td>Paquete 6 · Finca Las Camelias, San Juan de Bedout, Hacienda La Tagua</td><td>$841.000 – $1.507.000</td></tr>'
      +           '<tr><td class="mm-compare-route-name"><strong>Ruta 2</strong> · Descubre el corazón ganadero del Magdalena Medio</td><td>Paquete 7 · Patrimonio, lancha, sala lechera, Ciénaga Barbacoas, Las Camelias</td><td>$826.000 – $1.517.000</td></tr>'
      +         '</tbody>'
      +       '</table>'
      +       '<h3 class="mm-compare-section-title">Ruta 5 completa (6 días / 5 noches) vs Exclusive Nature Tours · por rubro</h3>'
