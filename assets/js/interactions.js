(function () {
  ...
  function mountCompareModal() {
    ...
    backdrop.innerHTML = ''
      ...
      +               '<p class="mm-compare-itin-lead">Itinerario según cotización PDF (Yopal–Casanare)</p>'
      +               '<p class="mm-compare-itin-day">Llegada</p>'
      ...
      +               '</ul>'
      +               '<p class="mm-compare-itin-day">Día 1</p>'
      +               '<ul class="mm-compare-itin-list">'
      ...
      +                 '<li>15:00–18:00 · Safari llanero.</li>'
      +                 '<li>18:00 · Traslado de regreso.</li>'
      +                 '<li>20:00–22:00 · Cena.</li>'
      +                 '<li>22:00 · Pernoctación hato ganadero.</li>'
      +               '</ul>'
      +               '<p class="mm-compare-itin-day">Día 2</p>'
      +               '<ul class="mm-compare-itin-list">'
      +                 '<li>07:00 · Desayuno.</li>'
      ...
      +                 '<li>22:00 · Pernoctación hotel Yopal.</li>'
      +               '</ul>'
      +               '<p class="mm-compare-itin-day">Día 3</p>'
      +               '<ul class="mm-compare-itin-list">'
      +                 '<li>07:00 · Desayuno.</li>'
      +                 '<li>08:00–11:00 · Jornada de retroalimentación.</li>'
      +                 '<li>12:00 · Almuerzo en hotel.</li>'
      +                 '<li>13:00 · Traslado hotel → aeropuerto.</li>'
      +                 '<li>14:30 · Regreso a ciudad de origen.</li>'
      +               '</ul>'
